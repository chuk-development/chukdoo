...
class _ProjectPageState extends ConsumerState<ProjectPage> {
  ...
  void _showAddTodoSheet(BuildContext context) {
    final currentProject =
        ref.read(projectProvider).getById(widget.project.id) ?? widget.project;
  ...
  Future<void> _openEditDialog(BuildContext context) async {
    ...
    final stillExists =
        ref.read(projectProvider).getById(widget.project.id) != null;
  ...
  Widget build(BuildContext context) {
    ...
    final currentProject =
        projectState.getById(widget.project.id) ?? widget.project;
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 64,
              color: Color(currentProject.color).withValues(alpha: 0.5),
            ),
